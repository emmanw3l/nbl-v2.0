...
export default function February2024() {
  ...
  return (
    ...
    >
      ...
      <div className="">
        <section id="february2024" className="">
          <h1 className="text-center twenty">FEBRUARY 2024</h1>
          <h3 className="jan-head text-center">Theme: Paradigm of love</h3>
          <h3 className="text-center">PROMPT: Paradigm of love</h3>
          <div className="page-container py-4">
            <div className="row justify-content-evenly">
              {februaryPrompts2024.map((prompts) => (
                <div
                  key={prompts.id}
                  className="mb-4 card col-md-5 col-10"
                  id={`februaryy-${slugify(prompts.id.toString())}`}
                >
