...
export default function March2024() {
  ...
  return (
    ...
    >
      ...
      <div className="">
        <section id="march2024" className="">
          <h1 className="text-center twenty">MARCH 2024</h1>
          <h3 className="jan-head text-center">Theme: She must be obeyed</h3>
          <h3 className="text-center">PROMPT: </h3>
          <div className="page-container py-4">
            <div className="row justify-content-evenly">
              {marchPrompts2024.map((prompts) => (
                <div
                  key={prompts.id}
                  className="mb-4 card col-md-5 col-10"
                  id={`march-${slugify(prompts.id.toString())}`}
                >
                  <h1 className="bold">{prompts.title}</h1>
                  <h4 className="text-end blockquote">Genre: {prompts.title1}</h4>
