...
export default function February2026() {
  ...
  return (
    ...
    >
      ...
      <div className="">
        <section id="february206" className="">
          <h1 className="text-center twenty">FEBRUARY 2026</h1>
          <h3 className="jan-head text-center">Theme: Love and Confessions</h3>
          <h3 className="text-center">PROMPT: Do I Choose Love?</h3>
          <div className="page-container py-4">
            <div className="row justify-content-evenly">
              {februaryPrompts2026.map((prompts) => (
                <div
                  key={prompts.id}
