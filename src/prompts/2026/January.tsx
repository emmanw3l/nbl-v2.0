...
export default function January2026() {
  ...
  return (
    ...
    >
      ...
      <div className="">
        <section id="january206" className="">
          <h1 className="text-center twenty">JANUARY 2026</h1>
          <h3 className="jan-head text-center">Theme: Making Audacious Moves</h3>
          <h3 className="text-center">PROMPT: When fear meets my eyes</h3>
          <div className="page-container py-4">
            <div className="row justify-content-evenly">
              {januaryPrompts2026.map((prompts) => (
                <div
                  key={prompts.id}
