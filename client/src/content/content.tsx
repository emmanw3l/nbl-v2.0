  ...
  return (
    ...
    >
      ...
      <div className="container-fluid mb-5">
        ...
        limits of their creativity as they engage in writing excercises,
        lectures, quizzes and other activities. <br />
        Some of the activities include{" "}
        <Link to="/mainPromptPage">Prompts:</Link> A monthly writing challenge
        where everyone is given a topic and told to write about it sometimes in
        a specific genre, but most times in any genre they're comfortable with.{" "}
        <br />
        Writing challlenges: This is very similar to the prompts but on a much
        smaller scale and usually in the form of friendly competition between
        two or more parties. <br />
        <Link to="/awards">Awards:</Link> This is very self-explanatory. At the
        end of the year, there are various categories to be nominated for and
        the best performer in that category gets the award. It's meant to incite
        competition and to congratulate standout performers. <br />
        <br />
        <h4 className="italics text-center">
          Preview of some of the best works over the years
        </h4>
        <div className="d-flex flex-column flex-md-row justify-content-center align-items-start gap-4">
          ...
          />
          <InstagramPost
            url="https://www.instagram.com/p/DGxl903teI-/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA=="
            maxWidth={375}
          />
          <InstagramPost
          url="https://www.instagram.com/p/DVY3xWNjTPY/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA=="
          maxWidth={375}
          />
        </div>
      </div>
          ...
          },
          {
            ...
            body: (
              <>
                ...
                <Link to="/mainPromptPage">prompts</Link> and other creative
                mediums. We always encourage people to write more and on diverse
                topics to bring out the best in them.
              </>
            ),
          },
          {
