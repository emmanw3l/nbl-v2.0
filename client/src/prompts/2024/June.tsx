...
export default function June2024() {
  ...
  return (
    ...
    >
      ...
      <div className="">
        <section id="june2024" className="">
          <h1 className="text-center twenty">JUNE 2024</h1>
          <h3 className="jan-head text-center">Theme: The Reality of Fatherhood</h3>
          <h3 className="text-center">PROMPT: The Reality of Fatherhood </h3>
          <div className="page-container py-4">
            <div className="row justify-content-evenly">
              {junePrompts2024.map((prompts) => (
                <div
                  key={prompts.id}
                  className="mb-4 card col-md-5 col-10"
                  id={`june-${slugify(prompts.id.toString())}`}
                >
