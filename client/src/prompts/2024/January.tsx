...
export default function January2024() {
  ...
  return (
    ...
    >
      ...
      <div className="">
        <section id="january2024" className="">
          <h1 className="text-center twenty">JANUARY 2024</h1>
          <h3 className="jan-head text-center">Theme: My new chapter</h3>
          <h3 className="text-center">PROMPT: My new chapter</h3>
          <div className="page-container py-4">
            <div className="row justify-content-evenly">
              {januaryPrompts2024.map((prompts) => (
                <div
                  key={prompts.id}
